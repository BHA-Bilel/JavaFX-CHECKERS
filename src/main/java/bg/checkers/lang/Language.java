...
public class Language {
    ...
    private static void load_arabic_strings() {
        ...
        WELCOME_C.set("أهلا! أنا بن حاج عمار بلال ، مطور هذه اللعبة"
                + "\n"
                + "\n"
                + "لعبة الداما الخاصة بي ليست لعبة عادية!"
                + "\n"
        ...
        DU_CHECKERS_H.set("تأكد أن لديك أحدث إصدار من الداما");
        DU_CHECKERS_C.set("نسختك الحالية هي: " + MainApp.CURRENT_VERSION + " ، تحقق من وجود إصدار جديد");
    ...
    private static void load_french_strings() {
        ...
        WELCOME_C.set("Salut! Je suis BENHADJ AMAR Bilel, le développeur de ce jeu"
                + "\n"
                + "\n"
                + "Mon jeu de dames n'est pas un jeu ordinaire !"
                + "\n"
        ...
        DU_CHECKERS_H.set("Assurez-vous d'avoir la dernière version de dames");
        DU_CHECKERS_C.set("Votre version actuelle est : "
    ...
    private static void load_english_strings() {
        ...
        WELCOME_C.set("Hi! I am BENHADJ AMAR Bilel, the developer of this game"
                + "\n"
                + "\n"
                + "My checkers game is no ordinary game!"
                + "\n"
        ...
        DU_CHECKERS_H.set("Make sure you have the latest version of checkers");
        DU_CHECKERS_C.set("Your current version is : " + MainApp.CURRENT_VERSION + ", Check for new version");
