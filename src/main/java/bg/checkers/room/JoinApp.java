package bg.checkers.room;

import bg.checkers.MainApp;
import bg.checkers.lang.Language;
import bg.checkers.popup.MyAlert;
import bg.checkers.server.local.LocalClient;
...
public class JoinApp extends VBox {
    ...
    private final bg.checkers.room.JoinApp.JoinClient joinClient;
    private Map<String, LocalRoomInfo> rooms;
    private bg.checkers.room.JoinApp.FeaturingGP featuringGP;
    ...
    public JoinApp(MainApp mainApp, String username, Socket joinSocket) {
        ...
        createGUI(username);
        joinClient = new bg.checkers.room.JoinApp.JoinClient(joinSocket);
    }
    ...
    public JoinApp(MainApp mainApp, String username, Map<String, LocalRoomInfo> rooms) {
        ...
        joinClient = new bg.checkers.room.JoinApp.JoinClient();
    }
    ...
    private void createGUI(String username) {
        ...
        featuringGP = new bg.checkers.room.JoinApp.FeaturingGP();
        ...
        public void attemptJoin(int roomID, String username) {
            ...
            Thread online_join = new Thread(() -> {
                try {
                    ...
                    RoomApp roomApp = new RoomApp(mainApp, bg.checkers.room.JoinApp.this, roomSocket, String.valueOf(roomID), username);
        ...
        public void attemptJoin(String ip, int roomID, String username) {
            ...
            Thread local_join = new Thread(() -> {
                try {
                    ...
                    RoomApp roomApp = new RoomApp(mainApp, bg.checkers.room.JoinApp.this, ip, roomSocket, username);
                    Platform.runLater(() -> mainApp.setRoomApp(roomApp));
                } catch (IOException e) {
                    try {
                        roomSocket.close();
